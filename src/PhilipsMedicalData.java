...
public class PhilipsMedicalData extends MedicalData {

    private MedicalDataFactory medicalDataFactory;

    public PhilipsMedicalData(MedicalDataFactory medicalDataFactory) {
        this.medicalDataFactory = medicalDataFactory;
    }

    @Override
    public void preapare() throws IOException, InterruptedException {
        System.out.println("\nPhilips medical data sensor is being used");
